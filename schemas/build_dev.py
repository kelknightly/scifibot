...
structure47 = 'The ' + secondary_actors + ' onboard the distant ' + transport_desc + ' ' + transport + ' have the taste for human blood. The ' + engine + ' on their ship is powerful.'
structure48 = 'The ' + secondary_actors + ' onboard the distant ' + transport_desc + ' ' + transport + ' have the taste for human blood. The ' + engine + ' on their ship is powerful. The human race will come to an end tonight.'
structure49 = 'The ' + secondary_actors + ' onboard the distant ' + transport_desc + ' ' + transport + ' have the taste for human blood. The ' + engine + ' on their ship is powerful. The human race faces exinction tonight.'
